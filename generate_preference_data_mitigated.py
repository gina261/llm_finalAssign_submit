...
output_dataset_path = "./dpo/dpo_preference_dataset_mitigated1000.jsonl"
debiased_weights_path = "./length_bias/debiased_score_weights_alpha0.9.pt"
...
print(f"'{debiased_weights_path}'에서 가중치 로드 중...")
saved_debiased_weights = torch.load(debiased_weights_path)
print("모델에 수정된 가중치 적용 중...")
reward_model.score.load_state_dict(saved_debiased_weights)
