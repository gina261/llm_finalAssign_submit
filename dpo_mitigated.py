...
preference_dataset_path = "./dpo/dpo_preference_dataset_mitigated1000.jsonl"
...
training_args = DPOConfig(
    ...
    seed=42,
    output_dir="final_dpo_adapter_mitigated", # 결과 저장 경로
)
...
model.save_pretrained("final_dpo_adapter_mitigated")

print("DPO 학습이 완료되었습니다.")
print("학습된 DPO LoRA 어댑터는 'final_dpo_adapter_mitigated' 폴더에 저장되었습니다.")
